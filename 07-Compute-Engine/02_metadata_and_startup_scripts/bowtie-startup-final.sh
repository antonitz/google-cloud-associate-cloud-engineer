...
<p>My machine name is <span style="color: #3BA959">$NAME</span>$NAME<span> and I serve the <span style="color: #3BA959">$ENV</span> environment.</p>
...
<p><img src="https://storage.googleapis.com/bowtie-site/tony-bowtie.svg" alt="Tony Bowtie"></p>
</body></html>
EOF